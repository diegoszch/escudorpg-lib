...
use Escudorpg\Olddragon\Common\Atributos\Sabedoria as CommonSabedoria;

/**
 * Classe responsavel pelo atributo Forca
 * 
...
{     
    ...
    /**
     * Retorna Ajuste de Protecao
     * @return int
     */
    public function getAjusteProtecao()
    {
